...
<template>
  ...
  >
    ...
    <div class="relative mx-auto max-w-6xl">
      <div class="grid items-center gap-8 rounded-3xl border border-white/20 bg-white/10 p-7 shadow-2xl shadow-black/20 backdrop-blur-md sm:p-10 lg:grid-cols-[1.2fr_0.8fr] lg:gap-12">
        <div>
        ...
        <div class="grid min-h-52 place-items-center text-[#e7b94c] lg:min-h-64">
          <slot name="visual" />
        </div>
      </div>
    </div>
